...
cap = cv2.VideoCapture('Lane Detection/challenge.mp4')
fourcc = cv2.VideoWriter_fourcc(*'XVID')
frame_width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
frame_height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))

out = cv2.VideoWriter('predict_turn.avi', fourcc, 30.0, (frame_width, frame_height))
...
while cap.isOpened():
    ...
    if result is not None:
        ...
        print("Warning: Empty frame detected, skipping frame.")
